                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-warning btn-round ml-12"
                                    href="<?= base_url('Admin/cetakPdfProject'); ?>">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-toggle="modal" title=""
                                                            data-target="#editModal<?= $row->project_id; ?>" class="btn btn-link btn-primary btn-lg"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<?= base_url('admin/deleteProject/' . $row->project_id); ?>" method="post">
...
<?php foreach ($project->result() as $row): ?>
<div class="modal fade" id="editModal<?= $row->project_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
            ...
            <div class="modal-body">
                <p class="small">Create a new row using this form, make sure you fill them
                    all</p>
                <form action="<?= base_url('admin/editProject/' . $row->project_id); ?>" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Project Id</label>
                                <input id="project_id" name="project_id" type="text" class="form-control"
                                value="<?= $row->project_id ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
